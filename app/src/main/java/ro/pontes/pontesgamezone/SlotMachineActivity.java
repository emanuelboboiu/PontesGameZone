...
public class SlotMachineActivity extends Activity {
    ...
    static class MyHandler extends Handler {
        ...
        MyHandler(SlotMachineActivity aSmActivity) {
            smActivity = new WeakReference<>(aSmActivity);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll = findViewById(R.id.llCylinders);

        // Get the text views into their global variables:
        tvSmStatus = findViewById(R.id.tvSmStatus);
        ...
        btSmNew = findViewById(R.id.btSmNew);
        btSmNew2 = findViewById(R.id.btSmNew2);
        btSmNew3 = findViewById(R.id.btSmNew3);
        btSmFire = findViewById(R.id.btSmFire);
        ...
        t.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                runOnUiThread(() -> {
                    ...
                    if (isStarted && isSpinning && spinningDurationPassed >= spinningDuration) {
                        isSpinning = false;
                        mHandler.sendEmptyMessageDelayed(FINISHED_PLAYING_VIA_HANDLER, 0);
                    }
                });
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mnuSmStatistics) {
            ...
            String message = String.format(getString(R.string.statistics_for_slot_machine), "" + numberOfPlayedHands, "" + moneyWon, "" + moneyLost, "" + ballance, "" + ballancePerHand);
