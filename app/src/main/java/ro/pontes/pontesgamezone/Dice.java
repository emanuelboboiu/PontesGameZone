...
public class Dice {
    ...
    // player is 1.
    private final String[] aPossesion; // the array which contains at 0 Dealer, 1
    // player.
    ...
    public void speakAllDiceWithVoice() {
        ...
        if (MainActivity.isSoundDice) {
            ...
            new Thread(() -> {
                ...
                for (int i = 0; i < aDice.length; i++) {
                    if (i < aDice.length - 1) {
                        SoundPlayer.playWaitFinal(context, MainActivity.currentLanguage + aDice[i]);
                    } else {
                        SoundPlayer.playWaitFinal(context, MainActivity.currentLanguage + aDice[i] + "a");
                    }
                } // end for.
    ...
    public void speakAllDiceWithTTS() {
        ...
        speak.say(message.toString(), false);
    ...
    public void draw(LinearLayout paramLL, int whoIs) {
        ...
        if (numberOfDice > 0) {
            ...
            for (int i = 0; i < numberOfDice; i++) {
                ...
                String tempString = String.format(resPossesionString, aPossesion[whoIs], "" + tempDie);
