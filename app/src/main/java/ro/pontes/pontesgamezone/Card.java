...
public class Card {
    ...
    private static final String[] valuesFirstLetter = new String[]{"x", "ace", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "jack", "queen", "king"};
    private static final String[] suitsFirstLetter = new String[]{"x", "c", "d", "h", "s"};
     ...
     *
     * @param theValue the value of the new card. For a regular card (non-joker), the
    ...
    public String toString() {
        if (suit == JOKER) {
            ...
            return String.format(resCardNameString, valueNames[this.value], suitNames[this.suit]);
        }
    }
