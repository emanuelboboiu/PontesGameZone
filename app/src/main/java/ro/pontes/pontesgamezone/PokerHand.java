...
public class PokerHand extends Hand {
    ...
    private boolean isFullHouse() {
        ...
        if (aValues.length == 5) {
            if ((aValues[0] == aValues[1] && aValues[1] == aValues[2]) && (aValues[3] == aValues[4])) {
                isFull = true;
                // The relative rank is the number composed by the middle and
                // the last one found in aValues:
                relativeRank = calculateRelativeRank(aValues[2], aValues[4]);
            } else if ((aValues[0] == aValues[1]) && (aValues[2] == aValues[3] && aValues[3] == aValues[4])) {
                isFull = true;
                // The relative rank is the number composed by the middle and
            ...
            if (aValues[i] == aValues[i - 1]) {
                ...
                if (x >= 2) {
                    ...
                    if (i == 2) {
                        ...
                        // values:
                        relativeRank = calculateRelativeRank(aValues[0], aValues[4], aValues[3]);
                    } else if (i == 3) {
                        // It means the relative rank will be composed of the
                        // one of the 2-4 values, the 5th and the first value:
                        relativeRank = calculateRelativeRank(aValues[1], aValues[4], aValues[0]);
                    } else if (i == 4) {
                        // It means the relative rank will be composed of the
                        // one of the 3-5 values, the 2nd and the first value:
                        relativeRank = calculateRelativeRank(aValues[2], aValues[1], aValues[0]);
                    }
                    break;
                }
            } else {
    ...
    private boolean isTwoPair() {
        ...
        if (aValues.length > 4 && (aValues[0] == aValues[1] && aValues[2] == aValues[3])) {
            isTwoPair = true;
            // The relative rank is the number composed by 3th, the first and
            // the last value:
            relativeRank = calculateRelativeRank(aValues[2], aValues[0], aValues[4]);
        } else if (aValues.length > 4 && (aValues[0] == aValues[1] && aValues[3] == aValues[4])) {
            isTwoPair = true;
            // The relative rank is the number composed by 4th the first and the
            // middle value:
            relativeRank = calculateRelativeRank(aValues[3], aValues[0], aValues[2]);
        } else if (aValues.length > 4 && (aValues[1] == aValues[2] && aValues[3] == aValues[4])) {
            isTwoPair = true;
            // The relative rank is the number composed by 4th, the 2nd and the
            // first value:
            relativeRank = calculateRelativeRank(aValues[3], aValues[1], aValues[0]);
        }
        return isTwoPair;
