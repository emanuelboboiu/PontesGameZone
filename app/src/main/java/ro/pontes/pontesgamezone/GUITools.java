...
public class GUITools {
	...
	public static void goToBathroom(Context context) {
		/** Called when the user clicks the bathroom option in menu: */
	...
	public static void goToPawnshop(Context context) {
		/** Called when the user clicks the pawn-shop option in menu: */
	...
	public static void goToCasinoEntrance(Context context) {
		/** Called when the user clicks the Go to start option in menu: */
	...
	// games:
	public static void showBonusStatistics(Context context,
			int curMoneyWonAsBonus) {
		GUITools.alert(context, context
				.getString(R.string.money_won_as_bonus_title),
				String.format(
						context.getString(R.string.money_won_as_bonus_message),
						MainActivity.curNickname, "" + curMoneyWonAsBonus, ""
								+ Dealer.moneyWonAsBonus24, ""
								+ Dealer.moneyWonAsBonus));
	...
	public static void showVirtualTime(Context context) {
		if (PawnshopActivity.psIsSold[1] == false) {
			...
			GUITools.alert(context, context
					.getString(R.string.saloon_virtual_time_title), String
					.format(context.getString(R.string.saloon_passed_day),
							GUITools.twoDigits(currentVirtualHour),
							GUITools.twoDigits(currentVirtualMinute)));
		} else {
			// The watch was sold to pawn shop:
			GUITools.alert(context,
					context.getString(R.string.saloon_virtual_time_title),
					context.getString(R.string.ps_clock_is_unavailable));
		}
