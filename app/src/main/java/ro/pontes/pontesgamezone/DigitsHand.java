...
public class DigitsHand {
     ...
     *
     * @param d the non-null digit to be added.
     * @throws NullPointerException if the parameter d is null.
     */
    public void addDigit(Digit d) {
        if (d == null) throw new NullPointerException("Can't add a null Digit to a hand.");
        hand.add(d);
    }
     ...
     *
     * @param d the digit to be removed. If d is null or if the digit is not
     ...
     *
     * @param position the position of the digit that is to be removed, where
     ...
     *
     * @param position the position of the digit that is to be returned
    ...
    public void drawDigits(LinearLayout paramLL, int whoIs) {
        ...
        if (getDigitCount() > 0) {
            ...
            for (int i = 0; i < getDigitCount(); i++) {
                ...
                String tempString = String.format(resPossesionString, aPossesion[whoIs], tempDigit);
