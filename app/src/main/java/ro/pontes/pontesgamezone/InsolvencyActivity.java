...
public class InsolvencyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv = findViewById(R.id.tvInsExplanations);
        tv.setText(String.format(getString(R.string.tv_ins_explanations), MainActivity.curNickname, "" + Dealer.insolvency));
    ...
    public void postInsolvency(View view) {
        ...
        if (name.length() >= 3) {
            ...
            Button bt = findViewById(R.id.btInsSend);
            bt.setEnabled(false);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (!wasSent) {
                new AlertDialog.Builder(this).setIcon(android.R.drawable.ic_dialog_alert).setTitle(R.string.confirmation).setMessage(R.string.really_leave_page).setPositiveButton(R.string.yes, (dialog, which) -> {
