...
public class Dealer {
    ...
    public boolean addBet() {
        ...
        if (lastBet <= myTotalMoney) {
            ...
            String message = String.format(context.getString(R.string.not_enough_money_to_bet), MainActivity.nickname, "" + lastBet, "" + myTotalMoney);
            if (myTotalMoney <= 0) {
                // You can play just for fun:
                message = String.format(context.getString(R.string.play_just_for_fun), MainActivity.curNickname);
            }
    ...
    public void changeBet() {
        ...
        if (!isBet) {
            ...
            // The body:
            tempMessage = String.format(context.getString(R.string.bet_dialog_body), MainActivity.curNickname);
    ...
    private void checkAndChangeBet(String tempBet) {
        ...
        if (isNumeric(tempBet)) {
            ...
            if (newBet > myTotalMoney) {
                String title = context.getString(R.string.warning);
                String message = String.format(context.getString(R.string.not_enough_money_to_bet), MainActivity.nickname, "" + newBet, "" + myTotalMoney);
                if (myTotalMoney <= 0) {
                    // You can play just for fun:
                    message = String.format(context.getString(R.string.play_just_for_fun), MainActivity.curNickname);
                }
    ...
    public void increaseNumberOfGamesForOrder() {
        ...
        set.saveIntSettings("numberOfGamesForOrder", SaloonActivity.numberOfGamesForOrder);
