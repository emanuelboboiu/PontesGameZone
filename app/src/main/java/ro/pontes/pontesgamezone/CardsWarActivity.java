...
public class CardsWarActivity extends Activity {
	...
	static class MyHandler extends Handler {
		...
		MyHandler(CardsWarActivity aCwActivity) {
			cwActivity = new WeakReference<CardsWarActivity>(aCwActivity);
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvCwStatus = (TextView) findViewById(R.id.tvCwStatus);
		tvMyMoney = (TextView) findViewById(R.id.tvMyMoney);
		tvMyBet = (TextView) findViewById(R.id.tvMyBet);
		tvMyCwTotal = (TextView) findViewById(R.id.tvMyCwTotal);
		tvDealersCwTotal = (TextView) findViewById(R.id.tvDealersCwTotal);
		...
		btCwBet = (Button) findViewById(R.id.btCwBet);
		btCwNew = (Button) findViewById(R.id.btCwNew);
		btCwFire = (Button) findViewById(R.id.btCwFire);
		btCwWithdraw = (Button) findViewById(R.id.btCwWithdraw);
		// Determine if the check_box war sounds is checked or not:
		cbtWarSounds = (CheckBox) findViewById(R.id.cbtWarSounds);
		...
		for (int i = 0; i < fires.length; i++) {
			fires[i] = new String("cw_fire" + (i + 1));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.mnuCwStatistics) {
			...
			String message = String.format(
					getString(R.string.statistics_for_cards_war), ""
	...
	public void takeCardActions(int whoIs) {
		...
		String tempString = String.format(resPossesionString,
				aPossesion[whoIs], card.toString());
	...
	public void updateTextViewsForTotals(int myHand, int dealersHand) {
		...
		tvDealersCwTotal.setText(String.format(strDealersCwTotal, ""
				+ dealersHand));
	...
	public void onCheckboxClicked(View view) {
		...
		case R.id.cbtWarSounds:
			if (checked) {
				MainActivity.isWarSounds = true;
			} else {
				MainActivity.isWarSounds = false;
			}
