...
public class BathroomActivity extends Activity {
	...
	static class MyHandler extends Handler {
		...
		MyHandler(BathroomActivity aBathActivity) {
			bathActivity = new WeakReference<BathroomActivity>(aBathActivity);
		}
	...
	private void setImagesStatus() {
		...
		for (int i = 1; i < objectNames.length; i++) {
			...
			String tempMessage = String.format(
					getString(R.string.bath_use_objects), objectNames[i]);
	...
	public void bathAction(final int which) {
		...
		if (curBathStatus == which) {
			...
			GUITools.alert(this, getString(R.string.warning), String.format(
					getString(R.string.bath_wrong_action_chosen),
	...
	public void updateStatus(String text) {
		TextView tv = (TextView) findViewById(R.id.tvBathroomStatus);
		tv.setText(text);
