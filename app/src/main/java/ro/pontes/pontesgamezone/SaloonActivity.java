...
public class SaloonActivity extends Activity {
    ...
    static class MyHandler extends Handler {
        ...
        MyHandler(SaloonActivity aSlActivity) {
            slActivity = new WeakReference<>(aSlActivity);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView wtv = findViewById(R.id.tvWelcomeToBarArea);
        wtv.setText(String.format(getString(R.string.saloon_title), MainActivity.curNickname));
        ...
        for (int i = 1; i < productNames.length; i++) {
            ...
            ibt.setContentDescription(String.format(tempMessage, productNames[i], "" + productPrices[i]));
    ...
    private void updateTextViews() {
        ...
        TextView tv = findViewById(R.id.tvSpentMoney);
        tv.setText(String.format(getString(R.string.saloon_spent_money), "" + spentMoney));
        ...
        tv = findViewById(R.id.tvNumberOfGamesForOrder);
        tv.setText(String.format(getString(R.string.saloon_number_of_games_for_order), "" + numberOfGamesForOrder));

        // Update the bonus percentage text view:
        tv = findViewById(R.id.tvActualBonusPercentage);
        tv.setText(String.format(getString(R.string.saloon_actual_bonus_percentage), "" + actualBonusPercentage));
    ...
    public void updateVirtualTime() {
        ...
        if (!PawnshopActivity.psIsSold[1]) {
            ...
            tv.setText(String.format(getString(R.string.saloon_passed_day), GUITools.twoDigits(curHour), GUITools.twoDigits(curMinute)));
        } else {
    ...
    public void orderSomething(final int which) {
        ...
        if (numberOfGamesForOrder >= minimumGamesBeforeOrder) {
            ...
            if (nrOfDrinks < 3 || which >= 6) {
                ...
                String tempBody = String.format(getString(R.string.saloon_new_order_message), MainActivity.curNickname, productNames[which], "" + productPrices[which]);
                new AlertDialog.Builder(this).setTitle(tempTitle).setMessage(tempBody).setIcon(android.R.drawable.ic_dialog_alert).setPositiveButton(android.R.string.yes, (dialog, whichButton) -> {
                    ...
                    if (price <= Dealer.myTotalMoney) {
                        ...
                        if (which < 6) {
                            ...
                            set.saveIntSettings("nrOfDrinks", nrOfDrinks);
                        } // end if it was a drink.

                        updateTextViews();

                        // Play a corresponding sound:
                        SoundPlayer.playSimple(mFinalContext, "snd_saloon" + which);
                    ...
                    // necessary money.
                        ...
                        // We haven't money:
                        GUITools.alert(mFinalContext, getString(R.string.warning), String.format(getString(R.string.saloon_not_enough_money), MainActivity.curNickname));
                    }
            ...
            GUITools.alert(this, getString(R.string.warning), String.format(getString(R.string.saloon_you_must_play_more), MainActivity.curNickname, "" + (minimumGamesBeforeOrder - numberOfGamesForOrder)));
    ...
    private void somethingIsBroken() {
        ...
        if (shookCount >= 2) {
            ...
            if (Dealer.myTotalMoney < 0) {
                ...
                GUITools.alert(this, getString(R.string.saloon_broken_title), String.format(getString(R.string.saloon_bottles_broken), MainActivity.curNickname, "" + compensation));
            }
            updateTextViews();
            // Post this statistic:
    ...
    private void exitBarWithoutMoney(String title, String message) {
        ...
        alert.setPositiveButton("Ok", (dialog, whichButton) -> SaloonActivity.this.finish());
        alert.show();
